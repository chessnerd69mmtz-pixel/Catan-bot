...
function App(){
  ...
  const openHistoryAnalyze=async(g)=>{
    ...
    const game={...g,gameId};
    setAnalysisReplay(game);setAnalysisIndex(0);setAnalysisPlaying(false);setAnalysisBusy(true);setTab("historyAnalyze");setScreen("playing");
  ...
  const closeOverlay=()=>{cancelActionConfirm();setTab("game");setQuickPanel(null);setDevOpen(false);setTradeOffer(null);setRobberVictim(null);setAnalysisReplay(null);setAnalysisIndex(0);setAnalysisPlaying(false);};
