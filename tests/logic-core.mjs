    ...
    for(const get of missing.slice(0,3)){
      ...
      for(const give of surplus.slice(0,3)){
        ...
        for(const offer of [one,two]){
          ...
          if(objectiveMissing.includes(get) || afterBest<beforeBest || immediate>.35)out.push({...offer,tradeObjective:get,tradeObjectiveGain:immediate+(objectiveMissing.includes(get)?1.25:0)});
        }
      }
    }
