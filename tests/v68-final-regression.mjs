...
const required=[
  ...
  ['multiple development purchases','devCardsBoughtThisTurn'],
  ['dev card deck pop','const card=deck[deck.length-1]'],
  ['dev card private ownership increment','development:{...p.development,[card]'],
  ['year of plenty duplicate selections','resources.length!==2'],
  ['monopoly expected collection','gain+=p.hand[target]||0'],
